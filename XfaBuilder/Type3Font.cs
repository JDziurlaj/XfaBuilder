...
namespace cute {
    ...
    */
    public class Type3Font : iTextSharp.text.pdf.BaseFont {
        
        private bool[] usedSlot;
        private iTextSharp.text.pdf.IntHashtable widths3 = new IntHashtable();
        ...
        private iTextSharp.text.pdf.PageResources pageResources = new PageResources();
        ...
        */    
        public Type3Font(iTextSharp.text.pdf.PdfWriter writer, char[] chars, bool colorized) : this(writer, colorized) {
        }
        ...
        * and only images as masks can be used
        */    
        public Type3Font(iTextSharp.text.pdf.PdfWriter writer, bool colorized) {
            this.writer = writer;
        ...
        */    
        virtual public iTextSharp.text.pdf.PdfContentByte DefineGlyph(char c, float wx, float llx, float lly, float urx, float ury) {
            if (c == 0 || c > 255)
        ...
        internal  int GetRawWidth(int c, String name) {
            return 0;
        }
        ...
        internal  void WriteFont(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.pdf.PdfIndirectReference piRef, Object[] oParams) {
            ...
            if ( firstChar == usedSlot.Length ) {
                throw new iTextSharp.text.DocumentException(MessageLocalization.GetComposedMessage("no.glyphs.defined.for.type3.font"));
            }
        ...
        */
        ...
        internal  byte[] ConvertToBytes(int char1) {
            if (CharExists(char1))
